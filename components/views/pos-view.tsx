...
import { Search, Plus, Minus, Trash2, FileText, ShoppingCart, X } from "lucide-react"
import { Button } from "@/components/ui/button"
import { productos, formatCurrency, IVA, type Producto } from "@/lib/data"
...
export function PosView() {
  ...
  async function completarVenta() {
    ...
    setFeedback(`Venta ${numero} completada · ${formatCurrency(total)}`)
    setCart([])
